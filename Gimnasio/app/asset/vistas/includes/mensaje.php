<div class="row mt-5">
    ...
    <div class="col-lg-7 mt-2 mb-5 form_login">
        <form class="form-signin" method="POST" action="?controller=User&accion=AgregarMensajeUser" id="mostrarClasesDesdeUser">
            ...
            <div class="row mt-5 text-center">
                ...
                <label class="col-lg-1"></label>
                <a class="btn btn-secondary btn-lg" href="?controller=User&accion=VerMensajeUser&id=<?$_SESSION['id'];?>">Ver mensajes</a>
                <label class="col-lg-1"></label>
            </div>
        </form>
    </div>
