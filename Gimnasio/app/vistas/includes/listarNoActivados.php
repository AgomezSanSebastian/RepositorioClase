<div class="container-fluid mt-5">
    <div class="text-center  pt-3">
        <h3>Usuarios NO activados del gimnasio:</h3>
    </div>
        ...
        <?php if (isset($datos)) {
            foreach ($datos as $dato) : ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?controller=user&accion=cambiarRol&id=<?= $dato['id'] ?>&rol=0">Hacer Administrador </a>
                        <a href="?controller=user&accion=cambiarRol&id=<?= $dato['id'] ?>&rol=1">Hacer Usuario </a>
                </tr>
