            ...
            <form class="form-signin" method="POST" action="actions/loginAct.php">
                ...
                <div class="form-group row invisible">
                    ...
                    <div class="col-lg-7 text-left">
                        <input type="text" class="form-control" id="rol" name="rol" placeholder="1" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7 text-left">
                        <input type="text" class="form-control" id="nif" name="nif" maxlength="9" placeholder="00000000X" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="imagen" class="col-lg-4 col-form-label text-center">Imagen: </label>
                    <div class="col-lg-7 text-left">
                        <input type="text" class="form-control" id="imagen" name="imagen" placeholder="" />
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7 text-left">
                        <input type="text" class="form-control" id="telefono" name="telefono" placeholder="666778899" />
                    </div>
                </div>
                <div class="form-group row">
